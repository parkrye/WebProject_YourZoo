...
export const RIG_SPECS: Partial<Record<MotionArchetype, RigSpec>> = {
  TALL_QUADRUPED: {
    parts: [
      { id: 'BACK_LEG', label: 'BACK LEGS', cx: 0.38, cy: 0.76, w: 0.26, h: 0.42, px: 0.5, py: 0.05, z: 0,
        motion: { swing: 0.55, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.06 } },
      { id: 'BODY', label: 'BODY', cx: 0.46, cy: 0.46, w: 0.62, h: 0.4, px: 0.5, py: 0.5, z: 1,
        motion: { swing: 0.03, bob: 0.02, sway: 0, beats: 2, phase: 0, idle: 0.35 } },
      { id: 'TAIL', label: 'TAIL', cx: 0.14, cy: 0.42, w: 0.2, h: 0.24, px: 0.9, py: 0.3, z: 1,
        motion: { swing: 0.3, bob: 0, sway: 0, beats: 1, phase: 0.25, idle: 0.5 } },
      { id: 'FRONT_LEG', label: 'FRONT LEGS', cx: 0.6, cy: 0.76, w: 0.26, h: 0.42, px: 0.5, py: 0.05, z: 2,
        motion: { swing: 0.55, bob: 0, sway: 0, beats: 1, phase: 0, idle: 0.06 } },
      { id: 'HEAD', label: 'HEAD AND NECK', cx: 0.76, cy: 0.24, w: 0.34, h: 0.4, px: 0.35, py: 0.9, z: 3,
  ...
  HEAVY_QUADRUPED: {
    parts: [
      { id: 'BACK_LEG', label: 'BACK LEGS', cx: 0.35, cy: 0.79, w: 0.26, h: 0.34, px: 0.5, py: 0.05, z: 0,
        motion: { swing: 0.45, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.06 } },
      { id: 'BODY', label: 'BODY', cx: 0.44, cy: 0.52, w: 0.66, h: 0.4, px: 0.5, py: 0.5, z: 1,
        motion: { swing: 0.04, bob: 0.024, sway: 0.008, beats: 2, phase: 0, idle: 0.35 } },
      { id: 'TAIL', label: 'TAIL', cx: 0.1, cy: 0.46, w: 0.2, h: 0.22, px: 0.9, py: 0.3, z: 1,
        motion: { swing: 0.26, bob: 0, sway: 0, beats: 1, phase: 0.3, idle: 0.5 } },
      { id: 'FRONT_LEG', label: 'FRONT LEGS', cx: 0.6, cy: 0.79, w: 0.26, h: 0.34, px: 0.5, py: 0.05, z: 2,
        motion: { swing: 0.45, bob: 0, sway: 0, beats: 1, phase: 0, idle: 0.06 } },
      { id: 'HEAD', label: 'HEAD AND MANE', cx: 0.76, cy: 0.4, w: 0.38, h: 0.42, px: 0.3, py: 0.7, z: 3,
  ...
  UPRIGHT_BIPED: {
    parts: [
      { id: 'BACK_ARM', label: 'FAR ARM', cx: 0.36, cy: 0.5, w: 0.2, h: 0.4, px: 0.5, py: 0.1, z: 0,
        motion: { swing: 0.5, bob: 0, sway: 0, beats: 1, phase: 0, idle: 0.1 } },
      { id: 'LEG', label: 'LEGS', cx: 0.5, cy: 0.8, w: 0.3, h: 0.36, px: 0.5, py: 0.08, z: 1,
        motion: { swing: 0.45, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.06 } },
      { id: 'BODY', label: 'BODY', cx: 0.5, cy: 0.5, w: 0.34, h: 0.42, px: 0.5, py: 0.9, z: 2,
        motion: { swing: 0.04, bob: 0.03, sway: 0.01, beats: 2, phase: 0, idle: 0.4 } },
      { id: 'HEAD', label: 'HEAD', cx: 0.52, cy: 0.2, w: 0.3, h: 0.28, px: 0.5, py: 0.95, z: 3,
        motion: { swing: 0.08, bob: 0.02, sway: 0, beats: 1, phase: 0.2, idle: 0.45 } },
      { id: 'FRONT_ARM', label: 'NEAR ARM', cx: 0.64, cy: 0.5, w: 0.2, h: 0.4, px: 0.5, py: 0.1, z: 4,
  ...
  WADDLER: {
    parts: [
      { id: 'BACK_WING', label: 'FAR WING', cx: 0.3, cy: 0.54, w: 0.16, h: 0.34, px: 0.6, py: 0.1, z: 0,
        motion: { swing: 0.34, bob: 0, sway: 0, beats: 2, phase: 0, idle: 0.3 } },
      { id: 'LEG', label: 'FEET', cx: 0.5, cy: 0.9, w: 0.32, h: 0.14, px: 0.5, py: 0.1, z: 1,
        motion: { swing: 0.16, bob: 0, sway: 0.01, beats: 1, phase: 0.5, idle: 0.06 } },
      { id: 'BODY', label: 'BODY', cx: 0.5, cy: 0.55, w: 0.44, h: 0.56, px: 0.5, py: 0.95, z: 2,
        // 뒤뚱거림은 몸통이 통째로 기우는 것이다. 다리가 아니라 여기가 크게 돈다.
        motion: { swing: 0.2, bob: 0.012, sway: 0, beats: 1, phase: 0, idle: 0.25 } },
      { id: 'HEAD', label: 'HEAD', cx: 0.5, cy: 0.2, w: 0.3, h: 0.26, px: 0.5, py: 0.95, z: 3,
        motion: { swing: 0.16, bob: 0.015, sway: 0, beats: 1, phase: 0.12, idle: 0.3 } },
      { id: 'FRONT_WING', label: 'NEAR WING', cx: 0.7, cy: 0.54, w: 0.16, h: 0.34, px: 0.4, py: 0.1, z: 4,
  ...
  SMALL_HOPPER: {
    parts: [
      { id: 'BACK_LEG', label: 'BACK LEGS', cx: 0.36, cy: 0.8, w: 0.28, h: 0.3, px: 0.5, py: 0.1, z: 0,
        motion: { swing: 0.4, bob: 0.03, sway: 0, beats: 1, phase: 0, idle: 0.08 } },
      { id: 'BODY', label: 'BODY', cx: 0.46, cy: 0.58, w: 0.46, h: 0.42, px: 0.5, py: 0.8, z: 1,
        motion: { swing: 0.05, bob: 0.06, sway: 0, beats: 1, phase: 0.1, idle: 0.3 } },
      { id: 'HEAD', label: 'HEAD AND EARS', cx: 0.68, cy: 0.28, w: 0.36, h: 0.46, px: 0.4, py: 0.9, z: 2,
        motion: { swing: 0.12, bob: 0.05, sway: 0, beats: 1, phase: 0.16, idle: 0.35 } },
      { id: 'FRONT_LEG', label: 'FRONT PAWS', cx: 0.62, cy: 0.82, w: 0.2, h: 0.24, px: 0.5, py: 0.1, z: 3,
  ...
  BROAD_WING: {
    parts: [
      { id: 'BACK_WING', label: 'FAR WING', cx: 0.36, cy: 0.4, w: 0.4, h: 0.36, px: 0.85, py: 0.4, z: 0,
        motion: { swing: 0.9, bob: 0.02, sway: 0, beats: 1, phase: 0.06, idle: 0.5 } },
      { id: 'TAIL', label: 'TAIL', cx: 0.24, cy: 0.72, w: 0.28, h: 0.3, px: 0.85, py: 0.2, z: 1,
        motion: { swing: 0.22, bob: 0, sway: 0, beats: 1, phase: 0.3, idle: 0.5 } },
      { id: 'BODY', label: 'BODY', cx: 0.5, cy: 0.52, w: 0.34, h: 0.46, px: 0.5, py: 0.5, z: 2,
        motion: { swing: 0.05, bob: 0.05, sway: 0, beats: 1, phase: 0, idle: 0.5 } },
      { id: 'HEAD', label: 'HEAD AND BEAK', cx: 0.68, cy: 0.24, w: 0.32, h: 0.3, px: 0.35, py: 0.9, z: 3,
        motion: { swing: 0.07, bob: 0.03, sway: 0, beats: 1, phase: 0.1, idle: 0.5 } },
      { id: 'FRONT_WING', label: 'NEAR WING', cx: 0.6, cy: 0.4, w: 0.4, h: 0.36, px: 0.15, py: 0.4, z: 4,
  ...
  ROUND_BIRD: {
    parts: [
      { id: 'BACK_WING', label: 'FAR WING', cx: 0.34, cy: 0.5, w: 0.3, h: 0.34, px: 0.85, py: 0.3, z: 0,
        motion: { swing: 0.6, bob: 0.02, sway: 0, beats: 1, phase: 0.06, idle: 0.45 } },
      { id: 'BODY', label: 'BODY', cx: 0.5, cy: 0.58, w: 0.44, h: 0.5, px: 0.5, py: 0.5, z: 1,
        motion: { swing: 0.03, bob: 0.06, sway: 0, beats: 1, phase: 0, idle: 0.5 } },
      { id: 'HEAD', label: 'HEAD', cx: 0.5, cy: 0.24, w: 0.42, h: 0.34, px: 0.5, py: 0.95, z: 2,
        motion: { swing: 0.06, bob: 0.03, sway: 0.006, beats: 1, phase: 0.12, idle: 0.5 } },
      { id: 'FRONT_WING', label: 'NEAR WING', cx: 0.66, cy: 0.5, w: 0.3, h: 0.34, px: 0.15, py: 0.3, z: 3,
  ...
  STREAMLINED: {
    parts: [
      { id: 'TAIL', label: 'TAIL FIN', cx: 0.14, cy: 0.5, w: 0.26, h: 0.42, px: 0.95, py: 0.5, z: 0,
        motion: { swing: 0.45, bob: 0, sway: 0, beats: 1, phase: 0.35, idle: 0.6 } },
      { id: 'BODY', label: 'BODY', cx: 0.52, cy: 0.5, w: 0.62, h: 0.4, px: 0.5, py: 0.5, z: 1,
        motion: { swing: 0.07, bob: 0.02, sway: 0, beats: 1, phase: 0, idle: 0.6 } },
      { id: 'FIN', label: 'FINS', cx: 0.5, cy: 0.28, w: 0.28, h: 0.22, px: 0.5, py: 0.95, z: 2,
        motion: { swing: 0.2, bob: 0, sway: 0, beats: 2, phase: 0.2, idle: 0.6 } },
      { id: 'HEAD', label: 'HEAD', cx: 0.8, cy: 0.5, w: 0.26, h: 0.34, px: 0.2, py: 0.5, z: 3,
  ...
  LOW_CRAWLER: {
    parts: [
      { id: 'LEG', label: 'LEGS', cx: 0.44, cy: 0.78, w: 0.5, h: 0.2, px: 0.5, py: 0.1, z: 0,
        motion: { swing: 0.3, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.08 } },
      { id: 'TAIL', label: 'TAIL', cx: 0.12, cy: 0.6, w: 0.26, h: 0.2, px: 0.95, py: 0.5, z: 1,
        motion: { swing: 0.34, bob: 0, sway: 0, beats: 1, phase: 0.3, idle: 0.5 } },
      { id: 'BODY', label: 'BODY', cx: 0.46, cy: 0.58, w: 0.6, h: 0.26, px: 0.5, py: 0.5, z: 2,
        motion: { swing: 0.04, bob: 0.014, sway: 0, beats: 1, phase: 0, idle: 0.4 } },
      { id: 'HEAD', label: 'HEAD AND JAWS', cx: 0.82, cy: 0.56, w: 0.3, h: 0.22, px: 0.15, py: 0.5, z: 3,
  ...
  SHELLED: {
    parts: [
      { id: 'BACK_LEG', label: 'BACK FEET', cx: 0.34, cy: 0.8, w: 0.22, h: 0.2, px: 0.5, py: 0.1, z: 0,
        motion: { swing: 0.34, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.1 } },
      { id: 'BODY', label: 'SHELL', cx: 0.46, cy: 0.5, w: 0.58, h: 0.42, px: 0.5, py: 0.6, z: 1,
        motion: { swing: 0.02, bob: 0.014, sway: 0, beats: 1, phase: 0, idle: 0.3 } },
      { id: 'FRONT_LEG', label: 'FRONT FEET', cx: 0.6, cy: 0.8, w: 0.22, h: 0.2, px: 0.5, py: 0.1, z: 2,
        motion: { swing: 0.34, bob: 0, sway: 0, beats: 1, phase: 0, idle: 0.1 } },
      { id: 'HEAD', label: 'HEAD AND NECK', cx: 0.82, cy: 0.6, w: 0.26, h: 0.24, px: 0.15, py: 0.6, z: 3,
  ...
  FREE: {
    parts: [
      { id: 'LEG', label: 'LEGS', cx: 0.5, cy: 0.82, w: 0.44, h: 0.3, px: 0.5, py: 0.1, z: 0,
        motion: { swing: 0.34, bob: 0, sway: 0, beats: 1, phase: 0.5, idle: 0.08 } },
      { id: 'BODY', label: 'BODY', cx: 0.5, cy: 0.52, w: 0.56, h: 0.5, px: 0.5, py: 0.8, z: 1,
        motion: { swing: 0.04, bob: 0.025, sway: 0, beats: 2, phase: 0, idle: 0.35 } },
      { id: 'HEAD', label: 'HEAD', cx: 0.56, cy: 0.22, w: 0.36, h: 0.32, px: 0.45, py: 0.9, z: 2,
